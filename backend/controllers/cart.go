...
func PaymentOrders() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		payload.RequestID = primitive.NewObjectID()
		payload.ExtraData = "Extra Data"
		...
		rawSignature.WriteString(strconv.Itoa(int(payload.Amount)))
		...
		rawSignature.WriteString(payload.RequestID.Hex())
